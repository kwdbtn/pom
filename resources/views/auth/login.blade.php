...
<head>
    ...
    <title>Login - Planned Outage Manager</title>
...
<body>
    ...
    <div id="page-container" class="main-content-boxed">
        ...
        <main id="main-container">
            ...
            <div class="bg-image" style="background-image: url('assets/img/photos/accra_at_night.jpg');">
                    ...
                    <div class="hero-static col-md-6 col-xl-4 d-flex align-items-center bg-white invisible"
                        ...
                        <div class="content content-full">
                            ...
                            <div class="px-30 py-10">
                                ...
                                <h1 class="h3 font-w700 mt-30 mb-10">Planned Outage Manager</h1>
                                <h2 class="h5 font-w400 text-muted mb-0">Sign in</h2>
                            </div>
                            <!-- END Header -->
